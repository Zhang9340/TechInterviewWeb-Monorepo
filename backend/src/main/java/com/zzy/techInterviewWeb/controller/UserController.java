...
import com.zzy.techInterviewWeb.model.dto.user.UserAddRequest;
import com.zzy.techInterviewWeb.model.dto.user.UserEditRequest;
import com.zzy.techInterviewWeb.model.dto.user.UserLoginRequest;
import com.zzy.techInterviewWeb.model.dto.user.UserQueryRequest;
import com.zzy.techInterviewWeb.model.dto.user.UserRegisterRequest;
import com.zzy.techInterviewWeb.model.dto.user.UserUpdateMyRequest;
import com.zzy.techInterviewWeb.model.dto.user.UserUpdateRequest;
...
import com.zzy.techInterviewWeb.config.WxOpenConfig;
...
import static com.zzy.techInterviewWeb.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Boolean> addUserSignIn(HttpServletRequest request) {
        // Login is required to perform sign-in
        User loginUser = userService.getLoginUser(request);
     ...
     *
     * @param year    The year (null indicates the current year)
     * @param request HTTP request
     * @return A map of sign-in records
     */
    @GetMapping("/get/sign_in")
    public BaseResponse<List<Integer>> getUserSignInRecord(Integer year, HttpServletRequest request) {
        // Login is required to access this method
        User loginUser = userService.getLoginUser(request);
